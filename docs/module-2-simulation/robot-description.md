---
sidebar_label: 'Chapter 5: Robot Description - From URDF to SDF'
description: 'an XML format designed to describe everything about a simulation environment, from robots and lights to physics and sensors.'
---
