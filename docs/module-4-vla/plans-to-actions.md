---
sidebar_label: 'Chapter 16: From LLM Plans to ROS 2 Actions'
description: 'An "Action Executor" node that closes the loop'
---

# Chapter 16: From LLM Plans to ROS 2 Actions
