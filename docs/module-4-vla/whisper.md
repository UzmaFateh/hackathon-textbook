---
sidebar_label: 'Chapter 13: Whisper - Integrating Voice Commands'
description: 'A powerful Automatic Speech Recognition (ASR) system, to allow our humanoid robot to understand spoken commands'
---
