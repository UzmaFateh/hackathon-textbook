---
sidebar_label: 'Chapter 12: Reinforcement Learning & Sim-to-Real Transfer'
description: 'A paradigm where an agent learns to make decisions by performing actions in an environment and receiving rewards or penalties'
---
